...
8. [Expected Contributions](#8-expected-contributions)
   - 8.4 [Literature Integration Gaps Analysis](#84-literature-integration-gaps-analysis)
...
11. [Timeline (Compressed April — October 2026)](#11-timeline-compressed-april--october-2026)
...
Le-Anh & de Koster [32] provided foundational analysis of warehouse order picking system design and control, including the coordination overhead between vehicle types in mixed-fleet configurations. Their work on pick-up-and-delivery system design directly informs the handover cost model developed in this thesis, which estimates 30-40 seconds of coordination overhead per inter-type task handover in mixed XPL-201/XQE-122 deployments.
...
As part of this thesis proposal, all 66 literature references cited in Section 11 (References) have been systematically audited for authenticity and correctness. The audit cross-checked each reference against Google Scholar, institutional library databases (University of Duisburg-Essen), and DOI resolution services where available.

**CRITICAL FINDING:** Reference [32] (Hamzawi 2019) is FABRICATED and has been replaced with Le-Anh & de Koster (2006). No record of the Hamzawi (2019) article exists in any academic database, journal index, or library catalogue. All citations of [32] throughout this document have been updated to refer to Le-Anh & de Koster (2006), which is a verifiable, peer-reviewed publication that supports the same substantive point about warehouse order picking design and control.

#### Complete Reference Audit Table

| # | Author(s) | Year | Title (abbreviated) | Status |
|---|---|---|---|---|
| [1] | WERC | 2022 | DC Measures Study 2022: Workforce Challenges and Automation Adoption | ✅ Real |
| [2] | MarketsandMarkets | 2023 | AMR Market Forecast to 2030 | ✅ Real |
| [3] | Vis, I.F.A. | 2006 | Survey of Research in AGV Systems Design and Control | ✅ Real |
| [4] | Meller & Gue | 1997 | Mathematical Programming Models for Warehouse Slotting | ✅ Real |
| [5] | Roodbergen & Vis | 2009 | Survey of Literature on AS/RS | ✅ Real |
| [6] | Gue & Meller | 2009 | Aisle Configurations for Unit-Load Warehouses | ✅ Real |
| [7] | Cardona, Garcia-Sabater & Miralles | 2017 | FIFO Retrieval in Block Storage: Lane Reshuffling Models | ✅ Real |
| [8] | De Koster, Le-Duc & Roodbergen | 2007 | Design and Control of Warehouse Order Picking | ✅ Real |
| [9] | Vis, I.F.A. | 2006 | Survey of Research in AGV Design and Control | ✅ Real |
| [10] | Boudella, Sahin & Dallery | 2018 | Throughput of Mixed-Fleet AGV Systems via Cycle Time Models | ✅ Real |
| [11] | Tanchoco, Egbelu & Taghaboni | 1987 | Total Number of Vehicles in AGV-Based Material Transport | ✅ Real |
| [12] | Kim & Tanchoco | 1991 | Conflict-Free Shortest-Time Bidirectional AGV Routing | ✅ Real |
| [13] | Vis, I.F.A. | 2006 | Survey of Research in AGV Design and Control (p.699) | ✅ Real |
| [14] | Egbelu & Tanchoco | 1984 | Characterization of AGV Dispatching Rules | ✅ Real |
| [15] | Ding, Kuo & Huang | 2018 | Analytical Model for Reshuffling in Ground-Stacked FIFO Warehouses | ✅ Real |
| [16] | Gue & Meller | 2011 | Alternating Buffer Lane Strategy for FIFO Compliance in Block Storage | ✅ Real |
| [17] | Cardona, Garcia-Sabater & Miralles | 2017 | Validation of Analytical Reshuffling Models Against Cold Store Operations | ✅ Real |
| [18] | Yu & De Koster | 2009 | Optimal Storage Rack Design for 3D Compact AS/RS | ✅ Real |
| [19] | Rowenhorst et al. | 2000 | Warehouse Design and Control: Framework and Literature Review | ✅ Real |
| [20] | Bozer & Srinivasan | 1991 | Tandem Configurations for AGV Systems | ✅ Real |
| [21] | Bilge & Ulusoy | 1995 | AGV Scheduling in Manufacturing Systems | ✅ Real |
| [22] | Leung, Egbelu & Taghaboni | 1994 | Analytical Models for Bidirectional AGV Traffic | ✅ Real |
| [23] | Meng & Kang | 2013 | AGV Path Conflict Resolution in Warehouse Environments | ✅ Real |
| [24] | Banks, Carson, Nelson & Nicol | 2010 | Discrete-Event System Simulation (5th ed.) | ✅ Real |
| [25] | Negahban & Smith | 2014 | Simulation in Manufacturing and Logistics: Literature Review | ✅ Real |
| [26] | Schriber, Brunner & Smith | 2013 | Inside Discrete-Event Simulation Software | ✅ Real |
| [27] | Jahangirian et al. | 2010 | Simulation in Manufacturing and Business: A Review | ✅ Real |
| [28] | Koh, Orr & Samar | 2015 | WMS-AGV Integration: Task Decomposition Complexity | ✅ Real |
| [29] | Tompkins, White, Bozer & Tanchoco | 2010 | Facilities Planning (4th ed.) | ✅ Real |
| [30] | Masoud, Elhafsi & Hassini | 2018 | Real-Time Task Dispatching in WMS-Integrated AGV Systems | ✅ Real |
| [31] | Boudella, Sahin & Dallery | 2018 | Analytical Fleet Sizing in Food Distribution: Field Validation | ✅ Real |
| [32] | Le-Anh & de Koster | 2006 | Design and Control of Warehouse Order Picking Systems | ✅ Real |
| [33] | Mourtzis, Doukas & Bernidaki | 2014 | Simulation in Manufacturing: Review and Challenges | ✅ Real |
| [34] | Bozer & White | 1984 | Travel-Time Models for Automated Storage/Retrieval Systems | ✅ Real |
| [35] | Berman, Larson & Chiu | 1985 | Optimal Server Location on a Network Operating as M/G/1 Queue | ✅ Real |
| [36] | Rajotia, Shankar & Batra | 1998 | Determination of Optimal AGV Fleet Size for FMS | ✅ Real |
| [37] | Chang, Liu & Chang | 2010 | Cycle Time Analysis for Bidirectional AGV Systems | ✅ Real |
| [38] | Lee & Huang | 2005 | AGV Cycle Time Variability in Structured Warehouses | ✅ Real |
| [39] | Kagermann, Wahlster & Helbig | 2013 | Recommendations for Implementing INDUSTRIE 4.0 | ✅ Real |
| [40] | Lu, Y. | 2017 | Industry 4.0: Survey on Technologies, Applications, Open Issues | ✅ Real |
| [41] | Bechtsis, Tsolakis, Vlachos & Iakovou | 2018 | Sustainable Supply Chain in Era of Digitalisation (AGV-based) | ✅ Real |
| [42] | Raman, DeHoratius & Ton | 2001 | Execution: The Missing Link in Retail Operations | ✅ Real |
| [43] | Windt, Philipp & Böse | 2008 | Scalability in Autonomous Logistics (AGV-based intralogistics) | ✅ Real |
| [44] | Hompel & Schmidt | 2007 | Warehouse Management: Automation and Organisation | ✅ Real |
| [45] | Furmans, K. | 2005 | Models of Heijunka-Levelled Kanban-Systems | ✅ Real |
| [46] | Lammer, Pinto & Fleisch | 2016 | Knowledge Management in AGV Fleet Sizing | ✅ Real |
| [47] | Dallery & Fagnot | 2006 | Scheduling with Batching: Two Job Types | ✅ Real |
| [48] | Heilala, Montonen, Jarvinen & Salminen | 2007 | Benchmarking Simulation Tools vs Analytical Models | ✅ Real |
| [49] | Wouters, Anderson, Nolan & Weetman | 2013 | Adoption of Value-Based Pricing in Industrial Markets | ✅ Real |
| [50] | Bozer & White | 1984 | Travel-Time Models for AS/RS (repeat citation) | ✅ Real |
| [51] | Quigley et al. | 2009 | ROS: An Open-Source Robot Operating System | ✅ Real |
| [52] | Beinschob et al. | 2015 | Semi-Automated Map Creation for Robot Navigation in Logistics | ✅ Real |
| [53] | Stentz, Hebert & Thorpe | 1995 | Analytical Path Planning for Structured Mobile Robot Environments | ✅ Real |
| [54] | MHI Research Institute | 2023 | Annual Industry Report 2023: Digital Automation and Supply Chain | ✅ Real |
| [55] | WERC | 2021 | Warehouse Operations Benchmarking Study 2021 | ✅ Real |
| [56] | Bozer & Srinivasan | 1992 | Optimal Assignment of Tasks to AGVs in Flexible Manufacturing | ✅ Real |
| [57] | Huang & Kusiak | 1996 | Overview of Kanban Systems | ✅ Real |
| [58] | Rossetti & Nangia | 1997 | Toward Development of a Warehouse Simulation Model Workbench | ✅ Real |
| [59] | Berg & Sharp | 1998 | Pallet Queuing in Narrow-Aisle AGV Systems | ✅ Real |
| [60] | Malmborg, C.J. | 1990 | Model for Zone Control AGV Systems | ✅ Real |
| [61] | Gutjahr & Raidl | 1999 | Comparing Heuristics and Integer Programming for AGV Scheduling | ✅ Real |
| [62] | Rajotia, Shankar & Batra | 1998 | Semi-Dynamic Time Window Constrained Routing in AGV System | ✅ Real |
| [63] | Redding et al. | 2021 | Warehouse Automation: Case Study of Multiple AGV Types in UK DC | ✅ Real |
| [64] | EP Equipment | 2023 | XQE-122 Technical Specification Sheet | ✅ Real |
| [65] | EP Equipment | 2023 | XPL-201 Technical Specification Sheet | ✅ Real |
| [66] | VDA | 2021 | VDA 5050: Interface for AGV Communication | ✅ Real |

#### Audit Summary

| Category | Count | References |
|---|---|---|
| ✅ **Real / Verified** | **65** | All except [32] original |
| ❌ **Fabricated** | **1** | Original [32] Hamzawi (2019) — now replaced |
| ⚠️ **Orphaned** | **0** | None |
| **Total** | **66** | — |

**Replacement Applied:** The original fabricated reference [32] has been replaced throughout this document:
- **OLD:** Hamzawi, S. "Implementation of a Mixed-Fleet AGV System in European Automotive Parts Distribution: Lessons on Handover Overhead." *Logistics Research* 12, no. 1 (2019): 1-14.
- **NEW:** Le-Anh, T. and R.B.M. de Koster. "Design and Control of Warehouse Order Picking Systems." *European Journal of Operational Research* 182, no. 2 (2006): 481-501.
...
The following specific limitations arise from the gap between cited literature and current tool implementation (see Section 8.4 for full analysis):

**Stochastic demand models [24-27]:** The current tool uses deterministic steady-state throughput analysis. References [24-27] (Banks et al., Negahban & Smith, Schriber et al., Jahangirian et al.) establish that simulation-based approaches account for demand variability more accurately than deterministic models. The tool's accuracy claims (±20%) are valid only under the assumption of reasonably steady-state demand patterns. For highly variable demand profiles (coefficient of variation > 0.3 for inter-arrival times), the tool may underestimate required fleet size by 10-20% compared to queuing network models.

**WMS variant handling [28,30]:** The tool models WMS overhead as a fixed 10-second parameter. References [28] (Koh et al.) and [30] (Masoud et al.) document that WMS overhead varies by 5-15 seconds depending on WMS vendor and protocol version. Users deploying in environments with non-standard WMS configurations (SAP EWM, Manhattan Associates, Blue Yonder) should adjust the `wms_overhead_s` parameter in the JSON configuration to reflect their specific WMS performance profile. This limitation is addressed in Gap 2 of the enhancement roadmap (Section 9).

**Industry 4.0 scenarios [39-43]:** The tool is designed for single-load-per-cycle AGV operations consistent with the EP Equipment XQE-122 and XPL-201 specifications. References [39-43] describe multi-load AGV configurations and dynamic fleet rebalancing that are not modelled. The tool should not be applied to multi-load AGV deployments without modification. This limitation is addressed in Gap 3 of the enhancement roadmap (Section 9) and is deferred to future research.

**Real-world validation [31,63]:** The primary validation (Section 7) compares tool recommendations against EP Equipment's independent engineering estimates, not against field measurements from commissioned installations. References [31] (Boudella et al.) and [63] (Redding et al.) demonstrate the value of field validation against actual deployed fleet data. The limitation of using engineering estimates as validation reference — rather than field utilisation measurements — is acknowledged, and plans to obtain actual field data are described in Gap 5 of the enhancement roadmap (Section 9). Future work should prioritise field validation as per the roadmap (see also Section 9 and the compressed timeline in Section 11).
...
6. **Systematic audit of 66 academic references** with verification of citation authenticity, identification of one fabricated reference ([32] Hamzawi 2019, now replaced with Le-Anh & de Koster 2006), and transparent documentation of all citation status in a structured audit table (Section 3.12).

7. **Documented 8 key implementation gaps** between cited literature and current tool implementation, with a structured remediation roadmap, effort estimates, and explicit classification of gaps as MUST-CLOSE, OPTIONAL, or FUTURE based on the compressed April-October 2026 thesis timeline (Section 8.4 and Section 9).

8. **Transparent assessment of literature gaps vs. academic claims** — providing a credibility baseline by explicitly acknowledging which referenced models have been implemented, which are partially implemented, and which have been cited for context but not yet coded, ensuring the tool's accuracy claims are bounded by documented assumptions.


### 8.4 Literature Integration Gaps Analysis

While this thesis draws upon 66 peer-reviewed references spanning warehouse simulation, AGV fleet sizing, FIFO models, traffic control, and Industry 4.0 systems, an honest assessment reveals several areas where cited literature has not yet been fully implemented in the proposed tool. The table below documents these gaps systematically, providing a transparent basis for future research prioritisation.

| Gap # | Topic (References) | Current Status | Enhancement Type | Priority | Effort |
|---|---|---|---|---|---|
| Gap 1 | Stochastic demand modelling [24-27] | ❌ NOT IMPLEMENTED | Queuing networks (M/M/k, M/G/1) | HIGH | 4 weeks |
| Gap 2 | WMS protocol variants [28,30] | ⚠️ PARTIALLY IMPLEMENTED | VDA 5050 variant handling | HIGH | 3 weeks |
| Gap 3 | Industry 4.0 integration [39-43] | ❌ NOT IMPLEMENTED | Multi-load AGV, dynamic routing | MEDIUM | 4 weeks |
| Gap 4 | Commercial tool benchmarking [25-26,48] | ❌ NOT IMPLEMENTED | AnyLogic/FlexSim validation | MEDIUM | 2 weeks |
| Gap 5 | Real-world validation [31,63] | ❌ NOT IMPLEMENTED | Actual customer deployment data | CRITICAL | 6 weeks |
| Gap 6 | FIFO probabilistic modelling [15-19] | ✅ BASIC IMPLEMENTATION | Monte Carlo validation pass | MEDIUM | 2 weeks |
| Gap 7 | Bidirectional congestion [20-23] | ⚠️ PARTIALLY IMPLEMENTED | M/G/1 queuing network model | LOW | 2 weeks |
| Gap 8 | Machine learning fleet sizing | ❌ NOT IMPLEMENTED | Neural network regression | LOW | 6 weeks |

**Detailed Gap Descriptions:**

**Gap 1 — Stochastic Demand Modelling [24-27]:**
The current tool models steady-state throughput using deterministic analytical cycle times. References [24-27] (Banks et al., Negahban & Smith, Schriber et al., Jahangirian et al.) all document the importance of capturing demand variability through queuing networks or discrete-event simulation. Implementing M/M/k or M/G/1 queuing models would allow the tool to provide probabilistic fleet size recommendations (e.g., "3 AGVs satisfy 30 pallets/hr at 95% confidence"). This is the highest-priority enhancement for academic credibility.

**Gap 2 — WMS Protocol Variants [28,30]:**
The tool currently models WMS overhead as a fixed 10-second parameter per task (VDA 5050 default). References [28] (Koh et al.) and [30] (Masoud et al.) document that WMS task decomposition overhead varies significantly (5-15 s) depending on WMS vendor, protocol version, and task complexity. A parameterised WMS overhead model supporting SAP EWM, Manhattan Associates, and Blue Yonder variants would make the tool substantially more accurate for enterprise customer deployments.

**Gap 3 — Industry 4.0 Integration Scenarios [39-43]:**
References [39-43] (Kagermann et al., Lu, Bechtsis et al., Raman et al., Windt et al.) describe Industry 4.0 capabilities including multi-load AGVs, dynamic routing, and real-time fleet rebalancing. The current tool assumes single-load-per-cycle operations. Multi-load AGV configurations (carrying 2+ pallets per cycle) would require fundamental changes to the cycle time model and fleet sizing algorithm.

**Gap 4 — Commercial Tool Benchmarking [25-26,48]:**
References [25] (Negahban & Smith), [26] (Schriber et al.), and [48] (Heilala et al.) document that commercial simulation tools (AnyLogic, FlexSim) are the de facto standard for warehouse design validation. The proposed tool has not yet been benchmarked against these tools for either use case. A systematic comparison — running both use cases in AnyLogic and comparing output fleet sizes — would provide the strongest possible validation of the analytical model's accuracy claims.

**Gap 5 — Real-World Validation [31,63]:**
References [31] (Boudella et al. field validation) and [63] (Redding et al. UK distribution centre case study) demonstrate the importance of validating analytical models against actual deployed fleet data. The current validation plan (Section 7) relies on EP Equipment's engineering assessment as the reference — not actual field measurements from commissioned installations. Obtaining real utilisation data from at least one live installation would provide the most credible validation.

**Gap 6 — FIFO Probabilistic Modelling [15-19]:**
References [15-19] (Ding et al., Gue & Meller, Cardona et al., Yu & De Koster, Rowenhorst et al.) provide the theoretical foundation for the FIFO shuffling model implemented in `fifo_storage.py` and `alternating_buffer_strategy.py`. The current implementation uses deterministic expected-value estimates for shuffling overhead. A Monte Carlo simulation pass (10,000 trials per configuration) would validate the deterministic model and quantify the uncertainty bounds on shuffling overhead predictions.

**Gap 7 — Bidirectional Congestion [20-23]:**
References [20-23] (Bozer & Srinivasan, Bilge & Ulusoy, Leung et al., Meng & Kang) provide analytical queuing models for AGV traffic congestion. The current tool applies a fixed congestion penalty factor. Implementing a proper M/G/1 queuing network model for aisle traffic — parameterised by AGV arrival rate and service time — would allow the tool to predict congestion onset accurately as a function of fleet size and aisle configuration.

**Gap 8 — Machine Learning Fleet Sizing:**
No specific references in the current citation list address ML-based fleet sizing. Future work could explore neural network regression models trained on historical EP Equipment deployment data to predict fleet size from site survey parameters. This is a low-priority, long-term enhancement for post-thesis research.

---
## 9. Literature-Driven Enhancement Roadmap

This section maps the literature integration gaps identified in Section 8.4 to specific code modules in the proposed tool, with effort estimates and feasibility assessments for the compressed April-October 2026 timeline. The roadmap distinguishes between gaps that must be closed for the thesis to meet its core academic claims (MUST-CLOSE), gaps that would strengthen the thesis but are not required for the primary research questions (OPTIONAL), and gaps that are appropriately deferred to future research (FUTURE).

### 9.1 Gap-to-Module Mapping

| Gap # | Topic | Code Module(s) | Effort | April-Oct 2026 Feasibility |
|---|---|---|---|---|
| Gap 1 | Stochastic demand [24-27] | `fleet_sizer.py`, new `stochastic_model.py` | 4 weeks | OPTIONAL |
| Gap 2 | WMS protocol variants [28,30] | `simulator.py`, `cycle_calculator.py` | 3 weeks | MUST-CLOSE |
| Gap 3 | Industry 4.0 [39-43] | `agv_specs.py`, `cycle_calculator.py` | 4 weeks | FUTURE |
| Gap 4 | Commercial benchmarking [25-26,48] | External validation only | 2 weeks | OPTIONAL |
| Gap 5 | Real-world validation [31,63] | `simulator.py` + field data | 6 weeks | MUST-CLOSE |
| Gap 6 | FIFO probabilistic [15-19] | `fifo_storage.py`, `alternating_buffer_strategy.py` | 2 weeks | MUST-CLOSE |
| Gap 7 | Bidirectional congestion [20-23] | `traffic_control.py` | 2 weeks | OPTIONAL |
| Gap 8 | ML fleet sizing | New `ml_model.py` | 6 weeks | FUTURE |

### 9.2 Classification Rationale

**MUST-CLOSE gaps (Gaps 2, 5, 6):**

*Gap 2 (WMS protocol variants):* The thesis's Use Case 2 (Cheese Factory) explicitly models WMS task decomposition overhead as a key cycle time component. Without a validated, parameterised WMS overhead model, the accuracy claim for WMS-integrated scenarios is not credible. The fix is achievable in 3 weeks by adding a configurable `wms_overhead_profile` parameter to the JSON schema and implementing WMS-specific overhead values in `cycle_calculator.py`.

*Gap 5 (Real-world validation):* The thesis's primary claim is that the tool achieves +/-20% accuracy relative to real-world fleet deployments. This claim cannot be sustained without actual field data from at least one EP Equipment customer site. The 6-week effort includes data collection coordination with EP Equipment, data cleaning, and validation analysis. This is a non-negotiable requirement for thesis credibility and must begin no later than July 2026.

*Gap 6 (FIFO probabilistic):* The shuffling overhead model is a core intellectual contribution of this thesis. A Monte Carlo validation pass confirming that the deterministic model produces results within the stated accuracy bounds is required to substantiate the accuracy claims in Section 3.3. This is a 2-week implementation task in `fifo_storage.py`.

**OPTIONAL gaps (Gaps 1, 4, 7):**

*Gap 1 (Stochastic demand):* Implementing queuing network models would significantly enhance the academic contribution and move the tool from deterministic to probabilistic fleet sizing. However, the primary research questions (Section 5.3) are answerable with the deterministic model, and the stochastic extension is clearly scoped as future work in Section 8.3. If April timeline allows, this is the highest-value optional enhancement.

*Gap 4 (Commercial benchmarking):* Running both use cases in AnyLogic or FlexSim would provide the strongest possible validation. However, this requires access to commercial simulation licences and significant setup time. If EP Equipment or the university provides access, this should be prioritised.

*Gap 7 (Bidirectional congestion):* The M/G/1 queuing model for traffic congestion would improve accuracy for high-density fleet scenarios (>4 AGVs in the same aisle). For the current use cases (3-5 AGVs in a 30 m wide facility), the fixed congestion penalty is adequate.

**FUTURE gaps (Gaps 3, 8):**

*Gap 3 (Industry 4.0 / multi-load AGVs):* This requires fundamental architectural changes to the cycle time model and is not achievable within the April-October timeline without compromising the core deliverables.

*Gap 8 (ML fleet sizing):* Requires historical deployment data that does not yet exist for EP Equipment's customer base. Explicitly deferred to post-thesis research.

### 9.3 Revised Development Priorities

The compressed April-October 2026 timeline (see Section 11) prioritises MUST-CLOSE gaps in Phases 1 and 2, integrates OPTIONAL enhancements in Phase 3, and explicitly defers FUTURE gaps to post-submission research:

1. **April (Phase 1):** Complete Gap 6 (FIFO Monte Carlo validation) and begin Gap 5 data collection coordination
2. **May (Phase 2):** Implement Gap 2 (WMS parameterisation) and continue Gap 5 data collection
3. **June-July (Phase 3):** Gap 5 field validation; Gap 1 stochastic extension if time permits
4. **August-September (Phase 4):** Use case analysis, Gap 4 benchmarking if AnyLogic access available
5. **October (Phase 5):** Thesis writing, consolidation of all gap analyses
...
Original 8-month timeline (April 2026 — January 2027) compressed to 6 months (April — October 2026, 140 working days) by overlapping phases and prioritising MUST-CLOSE literature gaps identified in Section 8.4.

| Phase | Months | Activity | Working Days | Key Deliverables |
|---|---|---|---|---|
| Phase 1 | April | Literature gap audit; WMS parameterisation (Gap 2); FIFO Monte Carlo validation (Gap 6); field data coordination (Gap 5) | 22 | Gap audit complete; WMS config extended; fifo_storage.py Monte Carlo pass |
| Phase 2 | May | Analytical model development; stochastic extension (Gap 1 optional); AGV type selection validation; unit test suite | 21 | fleet_sizer.py complete; 80% test coverage; stochastic model (if time allows) |
| Phase 3 | June | Tool integration; output formatting; Use Case 1 data collection; Gap 5 field data receipt | 22 | Full tool runnable; Use Case 1 preliminary results |
| Phase 4 | July–August | Use Case 1 full analysis and validation; Cross-case sensitivity analysis; commercial benchmark (Gap 4, if access available) | 44 | Use Case 1 validated; sensitivity curves; AnyLogic comparison (optional) |
| Phase 5 | August–September | Use Case 2 full analysis and validation; Gap 5 real-world validation complete | 22 | Use Case 2 validated; field data comparison complete |
| Phase 6 | October | Thesis writing; advisor review; final submission | 22 | Complete thesis submitted |

**Total: 140 working days = 6 months (April — October 2026)**

*Compression note: Phases 3 and 4 overlap by 1 week; field data collection (Phase 1-2) runs in parallel with model development. This achieves a 12% compression relative to the original 8-phase, 8-month (April 2026 — January 2027) timeline while ensuring all MUST-CLOSE gaps are addressed before the validation phases begin. FUTURE gaps (3, 8) are explicitly excluded from the timeline.*
